...
% Système d'axe
\draw[ultra thick, black, ->] (0,\gapfigure-\depassementsoudure-\distlegende) -- ++(\llegende,0) node[ right] {Y}; 
\draw[ultra thick, black] (0,\gapfigure-\depassementsoudure-\distlegende+0.5*\wlegendtail) -- ++(0,-\wlegendtail); 

\draw[ultra thick, black, ->] (-\distlegende,\gapfigure) -- ++(0,\llegende) node[ above] {X}; 
\draw[ultra thick, black] (-\distlegende-0.5*\wlegendtail,\gapfigure) -- ++(\wlegendtail,0); 
